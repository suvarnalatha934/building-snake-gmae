...
SEPARTION = 10  # separation between two pixels
SCREEN_HEIGHT = 600
SCREEN_WIDTH = 800
FPS = 25
...
class snake:
    def __init__(self,x,y):
        ...
        blackBox = segment(self.x, self.y + SEPARTION)
...
# we will define moves of the snake
    ...
    def grow(self):
        ...
        if(self.stack[last_element].direction == KEY["up"]):
            ...
            blackBox = segment(newSegment.x , newSegment.y- SEPARTION)
            ...
            blackBox = segment(newSegment.x - SEPARTION , newSegment.y)
